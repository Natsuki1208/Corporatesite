...
export const products: ProductDefinition[] = [
  {
    ...
    intro:L('Elias Knowledge 幫團隊找到可靠資訊，並附上資料來源。每個人都能回到原文確認，再繼續工作。','Elias Knowledge finds reliable information and includes the source with each answer. Anyone can check the original before continuing.'),
