...
export const products: ProductDefinition[] = [
  {
    ...
    intro:L('Elias Knowledge 幫團隊找到公司裡可靠的資訊，並把來源放在答案旁邊。我們可以回到原始文件確認，再決定怎麼使用。','Elias Knowledge finds reliable company information and keeps the source beside each answer. People can check the original before using it.'),
  ...
  },
  {
    ...
    intro:L('Elias Flow 把 Email、表單與文件整理成清楚的待辦，提醒負責的人並追蹤進度。重要決定由我們確認，完成後留下紀錄。','Elias Flow turns email, forms and documents into clear tasks, reminds the right people and tracks progress. People confirm important decisions, and completed work leaves a record.'),
  ...
  },
  {
    ...
    intro:L('Elias Ops 把分散的告警和處理紀錄整理成清楚的事件脈絡，幫維運團隊看懂影響。它會準備建議，實際操作仍由工程師決定。','Elias Ops turns scattered alerts and response history into a clear incident story. It prepares suggestions while engineers decide what action to take.'),
  ...
  },
  {
    ...
    intro:L('Elias Home 探索仿生人如何在家中安全移動，協助遞送物品與日常小事。它是生活中的好夥伴，不取代家人或照護者。','Elias Home explores safe movement, object delivery and simple help at home. It is a companion for daily life, not a replacement for family or caregivers.'),
  ...
  },
  {
    ...
    intro:L('Elias Rescue 探索機器人如何先進入危險區域，回傳現場資訊並運送物資。它與救援人員並肩工作，行動仍由專業團隊指揮。','Elias Rescue explores how robots can enter dangerous areas first, report conditions and carry supplies. It works alongside responders and remains under professional command.'),
