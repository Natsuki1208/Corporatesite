...
export const capabilities: CapabilityItem[] = [
  ...
  { id:'experience', name:{zh:'AI 體驗設計',en:'AI experience design'}, headline:{zh:'讓 AI 的協助自然進入工作',en:'Make AI assistance feel natural inside the work'}, summary:{zh:'把理解、建議、我們接手與例外處理設計成清楚、好使用的互動。',en:'Design understanding, suggestions, team handoffs and exceptions as a clear, usable experience.'}, problem:{zh:'通用聊天視窗無法配合角色與流程。',en:'A generic chat box does not fit each role or workflow.'}, assistance:{zh:'設計對話、操作節點、停止點與回饋方式。',en:'Design conversations, action points, stop points and feedback.'}, outcome:{zh:'建立團隊願意採用、知道如何掌握的體驗。',en:'An experience teams can adopt and understand how to control.'} },
