...
export const capabilities: CapabilityItem[] = [
  ...
  { id:'experience', name:{zh:'把 AI 放進工作流程',en:'Place AI inside the workflow'}, headline:{zh:'讓 AI 出現在需要的那一步',en:'Put AI where the work needs it'}, summary:{zh:'把理解、建議、我們接手與例外處理設計成清楚、好使用的互動。',en:'Design understanding, suggestions, team handoffs and exceptions as a clear, usable experience.'}, problem:{zh:'通用聊天視窗無法配合角色與流程。',en:'A generic chat box does not fit each role or workflow.'}, assistance:{zh:'設計對話、操作節點、停止點與回饋方式。',en:'Design conversations, action points, stop points and feedback.'}, outcome:{zh:'建立團隊願意採用、知道如何掌握的體驗。',en:'An experience teams can adopt and understand how to control.'} },
  ...
  { id:'agent', name:{zh:'建立有界線的 AI 協助',en:'Build bounded AI assistance'}, headline:{zh:'讓 AI 成為懂工作也懂界線的夥伴',en:'Make AI a partner that understands work and boundaries'}, summary:{zh:'依客服、營運、行政與資訊等不同工作，設計適合的 AI 協助方式。AI 負責整理、搜尋與提出建議；重要決定由我們掌握。',en:'Design AI support around the work of service, operations, administration and IT. AI organizes, searches and suggests. We make the important decisions.'}, problem:{zh:'通用 AI 不理解角色責任與工作限制。',en:'Generic AI does not understand role responsibilities or limits.'}, assistance:{zh:'定義任務、工具、資料、停止點，以及需要由我們接手的時刻。',en:'Define tasks, tools, data, stop points and when our team takes over.'}, outcome:{zh:'AI 能真正參與工作，我們也清楚掌握責任與選擇。',en:'AI can participate in the work while our team keeps clear ownership and choice.'} },
  ...
  { id:'governance', name:{zh:'把規則寫進每天的工作',en:'Put the rules into everyday work'}, headline:{zh:'創新前進，也知道何時停下',en:'Move innovation forward while knowing when to stop'}, summary:{zh:'先說清楚 AI 可以使用哪些資料、做到哪一步，以及什麼時候由我們確認，再用紀錄與測試持續改善。',en:'Clarify what data AI can use, how far it can go and when we review the work, then improve it through records and testing.'}, problem:{zh:'缺少界線與紀錄，AI 難以安心進入日常工作。',en:'Without boundaries and records, AI is difficult to trust in daily work.'}, assistance:{zh:'把允許、限制、例外、核准與驗證方式寫進流程。',en:'Build permissions, limits, exceptions, approvals and validation into the workflow.'}, outcome:{zh:'應用能被理解、管理並持續調整。',en:'Applications remain understandable, manageable and adaptable.'} }
];

export const workScenes: WorkScene[] = [
  {id:'service',role:{zh:'客服',en:'Customer service'},problem:{zh:'大量問題重複出現，複雜案件難以快速交接。',en:'Questions repeat while complex cases are difficult to hand over quickly.'},assistance:{zh:'整理意圖、摘要對話、建議回覆並找到適合的承接角色。',en:'Organize intent, summarize conversations, suggest responses and identify the right owner.'},human:{zh:'敏感內容、例外處理與最終回覆，由我們確認。',en:'We review sensitive content, handle exceptions and approve the final response.'},measure:{zh:'改善回覆一致性、縮短分類時間',en:'Improve response consistency and reduce triage time'}},
  {id:'operations',role:{zh:'營運',en:'Operations'},problem:{zh:'跨部門更新分散，異常與待辦不易整理。',en:'Cross-team updates are scattered, making anomalies and actions difficult to organize.'},assistance:{zh:'彙整狀態、找出差異並提出下一步檢查。',en:'Consolidate status, identify differences and suggest the next check.'},human:{zh:'優先順序與資源安排，由我們決定。',en:'We decide priorities and resource allocation.'},measure:{zh:'提升事件掌握速度、保留處理紀錄',en:'Increase event awareness and preserve action records'}},
  {id:'admin',role:{zh:'行政',en:'Administration'},problem:{zh:'表單、會議與文件整理占用大量時間。',en:'Forms, meetings and document preparation consume substantial time.'},assistance:{zh:'產生摘要、整理欄位、建立任務並追蹤待辦。',en:'Create summaries, organize fields, generate tasks and track follow-ups.'},human:{zh:'正式內容、規則與發布範圍，由我們確認後再繼續。',en:'We review official content, rules and publication scope before moving forward.'},measure:{zh:'減少重複整理、縮短文件準備時間',en:'Reduce repetitive organization and document preparation time'}},
  ...
  {id:'knowledge',role:{zh:'知識工作',en:'Knowledge work'},problem:{zh:'研究、規範與經驗分散，難以快速建立可靠脈絡。',en:'Research, policies and experience are scattered, slowing reliable context building.'},assistance:{zh:'搜尋核准內容、整理引用並建立可回顧草稿。',en:'Search approved content, organize references and create reviewable drafts.'},human:{zh:'內容由專業團隊驗證、補足判斷，成果仍由我們負責。',en:'Experts validate the content and add judgment; we remain responsible for the outcome.'},measure:{zh:'縮短查找時間、保留來源與修訂紀錄',en:'Reduce retrieval time and preserve sources and revisions'}}
];
...
export const cases: CaseStudy[] = [
  {id:'knowledge',tag:{zh:'應用情境 A',en:'Use case A'},title:{zh:'企業知識搜尋助理',en:'Enterprise knowledge search assistant'},problem:{zh:'文件分散，員工查找與確認耗時。',en:'Documents are scattered, making employee search and verification slow.'},assistance:{zh:'整合核准文件，提供附來源、可追溯的回答。',en:'Connect approved documents and provide sourced, traceable answers.'},human:{zh:'重要資訊、文件權限與正式內容，由我們確認。',en:'We review important information, document access and official content.'},image:'/images/elias-net-shared-knowledge.jpg'},
  {id:'service',tag:{zh:'應用情境 B',en:'Use case B'},title:{zh:'智慧客服協作助理',en:'AI-assisted service companion'},problem:{zh:'大量重複詢問與轉派，交接內容不一致。',en:'Repeated questions and routing create inconsistent handoffs.'},assistance:{zh:'整理意圖、建立摘要並提出建議回覆。',en:'Organize intent, create a summary and suggest a response.'},human:{zh:'例外、敏感內容與最終回覆，由我們處理。',en:'We handle exceptions, sensitive content and final replies.'},image:'/images/elias-net-services-landscape.jpg'},
...
export const governanceItems = [
  ...
  {id:'human',title:{zh:'重要決定與例外處理',en:'Important decisions and exceptions'},copy:{zh:'重要決定、敏感內容與高影響操作由我們掌握。',en:'We retain control of important decisions, sensitive content and high-impact actions.'}},
