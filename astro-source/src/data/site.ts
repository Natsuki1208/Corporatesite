...
export const cases: CaseStudy[] = [
  ...
  {id:'service',tag:{zh:'概念示範 B',en:'Concept demo B'},title:{zh:'智慧客服協作助理',en:'AI-assisted service companion'},problem:{zh:'大量重複詢問與轉派，交接內容不一致。',en:'Repeated questions and routing create inconsistent handoffs.'},assistance:{zh:'整理意圖、建立摘要並提出建議回覆。',en:'Organize intent, create a summary and suggest a response.'},human:{zh:'例外、敏感內容與最終回覆，由我們處理。',en:'We handle exceptions, sensitive content and final replies.'},image:'/images/elias-net-services-landscape.jpg'},
