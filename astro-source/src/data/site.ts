...
export const capabilities: CapabilityItem[] = [
  { id:'strategy', name:{zh:'從問題找起',en:'Start with the work problem'}, headline:{zh:'先找到最值得改善的工作',en:'Find the work that is worth changing first'}, summary:{zh:'從企業問題與工作現況出發，找出價值清楚、風險可控的 AI 起點。',en:'Start from the business problem and current work to identify an AI opportunity with clear value and manageable risk.'}, problem:{zh:'想導入 AI，卻不知道哪個場景最值得先做。',en:'The organization wants AI but does not know where to begin.'}, assistance:{zh:'盤點角色、流程、資料與成功條件，排出驗證順序。',en:'Map roles, workflows, data and success criteria to prioritize validation.'}, outcome:{zh:'形成清楚的應用方向與分階段路線。',en:'A clear application direction and phased path.'} },
  { id:'experience', name:{zh:'把 AI 放進工作流程',en:'Place AI inside the workflow'}, headline:{zh:'讓 AI 出現在需要的那一步',en:'Put AI where the work needs it'}, summary:{zh:'把理解、建議、人工接手與例外處理，做成清楚好用的互動。',en:'Design understanding, suggestions, human handoffs and exceptions as a clear, usable experience.'}, problem:{zh:'通用聊天視窗無法配合角色與流程。',en:'A generic chat box does not fit each role or workflow.'}, assistance:{zh:'設計對話、操作節點、停止點與回饋方式。',en:'Design conversations, action points, stop points and feedback.'}, outcome:{zh:'建立團隊願意採用，也知道如何掌握的體驗。',en:'An experience teams can adopt and know how to control.'} },
  { id:'data', name:{zh:'把資料整理成可信脈絡',en:'Turn data into trustworthy context'}, headline:{zh:'答案先說清楚從哪裡來',en:'Answers should show where they came from'}, summary:{zh:'整理核准知識、資料關係、來源與版本，讓 AI 能在明確範圍內工作。',en:'Organize approved knowledge, data relationships, sources and versions so AI works within a defined scope.'}, problem:{zh:'文件與資料分散，來源與版本不容易確認。',en:'Documents and data are scattered, with unclear sources and versions.'}, assistance:{zh:'建立資料邊界、索引、關聯與可追溯來源。',en:'Establish data boundaries, indexes, relationships and traceable sources.'}, outcome:{zh:'資訊更容易查找、驗證與持續更新。',en:'Information becomes easier to find, verify and maintain.'} },
  { id:'agent', name:{zh:'建立有界線的 AI 協助',en:'Build bounded AI assistance'}, headline:{zh:'讓 AI 懂工作，也懂界線',en:'Make AI understand the work and its boundaries'}, summary:{zh:'依客服、營運、行政與資訊等工作，設計適合的 AI 協助方式。AI 整理、搜尋並提出建議；重要決定由負責團隊掌握。',en:'Design AI support for service, operations, administration and IT. AI organizes, searches and suggests; responsible teams retain the important decisions.'}, problem:{zh:'通用 AI 不理解角色責任與工作限制。',en:'Generic AI does not understand role responsibilities or limits.'}, assistance:{zh:'定義任務、工具、資料、停止點，以及需要由指定人員接手的時刻。',en:'Define tasks, tools, data, stop points and when designated people take over.'}, outcome:{zh:'AI 能參與工作，使用團隊仍掌握責任與選擇。',en:'AI can participate while the team retains responsibility and choice.'} },
  { id:'integration', name:{zh:'接上原本的工具',en:'Connect the tools already in use'}, headline:{zh:'讓工作連起來，不再手動搬資料',en:'Connect the work instead of moving data by hand'}, summary:{zh:'以分階段方式連接企業工具、資料介面與日常流程，不必一次汰換既有系統。',en:'Connect business tools, data interfaces and daily workflows in stages without replacing everything at once.'}, problem:{zh:'工作跨越多個系統，資訊需要反覆搬運。',en:'Work spans multiple systems and information is repeatedly moved by hand.'}, assistance:{zh:'設計介面、流程節點、復原方式與導入順序。',en:'Design interfaces, workflow points, recovery paths and rollout order.'}, outcome:{zh:'形成連續、可追蹤且能逐步擴充的工作方式。',en:'A connected, traceable way of working that can expand over time.'} },
  { id:'governance', name:{zh:'把規則寫進每天的工作',en:'Put the rules into everyday work'}, headline:{zh:'向前走，也知道何時停下',en:'Move forward while knowing when to stop'}, summary:{zh:'先說清楚 AI 可以使用哪些資料、做到哪一步，以及何時由指定人員確認，再用紀錄與測試持續改善。',en:'Clarify what data AI can use, how far it can go and when designated people review the work, then improve it through records and testing.'}, problem:{zh:'缺少界線與紀錄，AI 難以安心進入日常工作。',en:'Without boundaries and records, AI is difficult to trust in daily work.'}, assistance:{zh:'把允許、限制、例外、核准與驗證方式寫進流程。',en:'Build permissions, limits, exceptions, approvals and validation into the workflow.'}, outcome:{zh:'應用能被理解、管理並持續調整。',en:'Applications remain understandable, manageable and adaptable.'} }
];

export const workScenes: WorkScene[] = [
  {id:'service',role:{zh:'客服',en:'Customer service'},problem:{zh:'大量問題重複出現，複雜案件難以快速交接。',en:'Questions repeat while complex cases are difficult to hand over quickly.'},assistance:{zh:'整理意圖、摘要對話、建議回覆並找到適合的承接角色。',en:'Organize intent, summarize conversations, suggest responses and identify the right owner.'},human:{zh:'敏感內容、例外處理與最終回覆，由客服人員確認。',en:'Service staff review sensitive content, handle exceptions and approve the final response.'},measure:{zh:'改善回覆一致性、縮短分類時間',en:'Improve response consistency and reduce triage time'}},
  {id:'operations',role:{zh:'營運',en:'Operations'},problem:{zh:'跨部門更新分散，異常與待辦不易整理。',en:'Cross-team updates are scattered, making anomalies and actions difficult to organize.'},assistance:{zh:'彙整狀態、找出差異並提出下一步檢查。',en:'Consolidate status, identify differences and suggest the next check.'},human:{zh:'優先順序與資源安排，由營運團隊決定。',en:'Operations teams decide priorities and resource allocation.'},measure:{zh:'提升事件掌握速度、保留處理紀錄',en:'Increase event awareness and preserve action records'}},
  {id:'admin',role:{zh:'行政',en:'Administration'},problem:{zh:'表單、會議與文件整理占用大量時間。',en:'Forms, meetings and document preparation consume substantial time.'},assistance:{zh:'產生摘要、整理欄位、建立任務並追蹤待辦。',en:'Create summaries, organize fields, generate tasks and track follow-ups.'},human:{zh:'正式內容、規則與發布範圍，由指定人員確認後再繼續。',en:'Designated staff review official content, rules and publication scope before moving forward.'},measure:{zh:'減少重複整理、縮短文件準備時間',en:'Reduce repetitive organization and document preparation time'}},
  {id:'it',role:{zh:'資訊',en:'IT'},problem:{zh:'服務、事件與知識散落在不同工具。',en:'Services, events and knowledge are distributed across tools.'},assistance:{zh:'整理事件脈絡、提供查詢入口並建議檢查順序。',en:'Assemble event context, provide a query entry point and suggest check order.'},human:{zh:'權限、變更與重要操作，由資訊團隊確認後再繼續。',en:'The IT team reviews permissions, changes and critical actions before proceeding.'},measure:{zh:'縮短查找時間、提升事件掌握速度',en:'Reduce search time and improve event awareness'}},
  {id:'management',role:{zh:'管理決策',en:'Management'},problem:{zh:'關鍵資訊分散，會議前仍需人工拼接。',en:'Critical information is scattered and still manually assembled before decisions.'},assistance:{zh:'整理重點、差異、風險與需要確認的假設。',en:'Organize key points, changes, risks and assumptions that require confirmation.'},human:{zh:'重要選擇、取捨與最終決策，由管理團隊掌握。',en:'The management team retains the important choices, trade-offs and final decisions.'},measure:{zh:'縮短資訊準備時間、提升決策可追溯性',en:'Reduce preparation time and improve decision traceability'}},
  {id:'knowledge',role:{zh:'知識工作',en:'Knowledge work'},problem:{zh:'研究、規範與經驗分散，難以快速建立可靠脈絡。',en:'Research, policies and experience are scattered, slowing reliable context building.'},assistance:{zh:'搜尋核准內容、整理引用並建立可回顧草稿。',en:'Search approved content, organize references and create reviewable drafts.'},human:{zh:'內容由專業團隊驗證並補足判斷，成果由指定負責人確認。',en:'Experts validate the content and add judgment; designated owners approve the outcome.'},measure:{zh:'縮短查找時間、保留來源與修訂紀錄',en:'Reduce retrieval time and preserve sources and revisions'}}
];
...
export const adoptionStages: AdoptionStage[] = [
  ...
  {id:'validate',name:{zh:'使用真實流程驗證',en:'Validate in the real workflow'},action:{zh:'在受控範圍觀察使用與例外。',en:'Observe use and exceptions within a controlled scope.'},input:{zh:'實際流程、測試角色與回饋。',en:'Real workflow, test roles and feedback.'},delivery:{zh:'驗證結果、風險與改善清單。',en:'Validation findings, risks and improvements.'},check:{zh:'確認價值、準確性與團隊接手方式。',en:'Confirm value, quality and how the team takes over.'}},
  {id:'integrate',name:{zh:'分階段串接與導入',en:'Integrate in stages'},action:{zh:'依核准範圍連接工具、資料與流程。',en:'Connect tools, data and workflows within approved scope.'},input:{zh:'權限、介面與變更時程。',en:'Permissions, interfaces and change schedule.'},delivery:{zh:'分階段整合與復原方案。',en:'Phased integration and recovery plan.'},check:{zh:'每階段驗證後才進入下一步。',en:'Validate each phase before moving forward.'}},
...
export const cases: CaseStudy[] = [
  {id:'knowledge',tag:{zh:'應用情境 A',en:'Use case A'},title:{zh:'企業知識搜尋助理',en:'Enterprise knowledge search assistant'},problem:{zh:'文件分散，員工查找與確認耗時。',en:'Documents are scattered, making employee search and verification slow.'},assistance:{zh:'整合核准文件，提供附來源、可追溯的回答。',en:'Connect approved documents and provide sourced, traceable answers.'},human:{zh:'重要資訊、文件權限與正式內容，由知識負責人確認。',en:'Knowledge owners review important information, document access and official content.'},image:'/images/elias-net-shared-knowledge.jpg'},
  {id:'service',tag:{zh:'應用情境 B',en:'Use case B'},title:{zh:'智慧客服協作助理',en:'AI-assisted service companion'},problem:{zh:'大量重複詢問與轉派，交接內容不一致。',en:'Repeated questions and routing create inconsistent handoffs.'},assistance:{zh:'整理意圖、建立摘要並提出建議回覆。',en:'Organize intent, create a summary and suggest a response.'},human:{zh:'例外、敏感內容與最終回覆，由客服人員處理。',en:'Service staff handle exceptions, sensitive content and final replies.'},image:'/images/elias-net-services-landscape.jpg'},
  {id:'operations',tag:{zh:'應用情境 C',en:'Use case C'},title:{zh:'夜間維運協作助理',en:'Off-hours operations assistant'},problem:{zh:'非上班時段的異常資訊分散，影響難以快速判斷。',en:'Off-hours anomaly information is scattered, making impact hard to assess.'},assistance:{zh:'以唯讀方式整理事件、影響與處理建議。',en:'Organize events, impact and suggested checks through read-only access.'},human:{zh:'重要操作必須等待資訊人員確認；展示不連接真實設備。',en:'Critical actions wait for IT confirmation; the demo connects to no real device.'},image:'/images/elias-net-ai-operations.jpg'}
];
...
export const governanceItems = [
  ...
  {id:'human',title:{zh:'重要決定與例外處理',en:'Important decisions and exceptions'},copy:{zh:'重要決定、敏感內容與高影響操作，由指定負責人掌握。',en:'Designated owners retain control of important decisions, sensitive content and high-impact actions.'}},
