    ...
    <section id="ai-change" class="main-section contact ai-change-section" data-section="ai-change" aria-labelledby="ai-change-title">
      <div class="shell ai-change-stage" data-ai-change data-active-change="0" aria-labelledby="ai-change-title">
        ...
        <div class="ai-change-copy" id="ai-change-panel" role="tabpanel" aria-labelledby="ai-change-tab-0">
          ...
          <p data-ai-change-copy>先把分散的設備、雲端與事件訊號帶回同一個營運視野。</p>
        </div>
        <div class="ai-change-nav" role="tablist" aria-label="AI CHANGE 主題">
          <button id="ai-change-tab-0" type="button" role="tab" aria-controls="ai-change-panel" aria-selected="true" data-ai-change-tab="0"><span>01</span>訊號</button>
          <button id="ai-change-tab-1" type="button" role="tab" aria-controls="ai-change-panel" aria-selected="false" data-ai-change-tab="1"><span>02</span>脈絡</button>
    ...
    <section id="contact" class="main-section contact readiness-section" data-section="contact" aria-labelledby="contact-title">
      <div class="shell readiness-console reveal" data-readiness-console>
        ...
        <div class="readiness-grid">
          <div class="readiness-step"><span>STEP 01</span><h3 data-en="What do you need to address first?">目前最需要處理什麼？</h3><div class="choice-grid" role="group" aria-label="整合需求類型" data-label-en="Integration need type"><button type="button" data-readiness-type="infrastructure" aria-pressed="false" data-en="Infrastructure">基礎架構</button><button type="button" data-readiness-type="cloud" aria-pressed="false" data-en="Cloud and identities">雲端與帳號</button><button type="button" data-readiness-type="security" aria-pressed="false" data-en="Security and monitoring">資安與監控</button><button type="button" data-readiness-type="automation" aria-pressed="false" data-en="Operations automation">維運自動化</button><button type="button" data-readiness-type="ai" aria-pressed="false" data-en="AI operations">AI 智慧維運</button></div></div>
          <div class="readiness-step"><span>STEP 02</span><h3 data-en="What is the main difficulty?">目前主要困難？</h3><div class="choice-grid readiness-difficulties" role="group" aria-label="主要困難" data-label-en="Primary difficulty" data-readiness-difficulties><p data-en="Select a priority in step one.">請先選擇第一步需求。</p></div></div>
...
export const en = putAiChangeLast(String.raw`
    <section id="ai-change" class="main-section contact ai-change-section" data-section="ai-change" aria-labelledby="ai-change-title">
      <div class="shell ai-change-stage" data-ai-change data-active-change="0" aria-labelledby="ai-change-title">
        ...
        <div class="ai-change-copy" id="ai-change-panel" role="tabpanel" aria-labelledby="ai-change-tab-0">
          ...
          <p data-ai-change-copy>Bring infrastructure, cloud and event signals into one operational view.</p>
        </div>
        <div class="ai-change-nav" role="tablist" aria-label="AI CHANGE themes">
          <button id="ai-change-tab-0" type="button" role="tab" aria-controls="ai-change-panel" aria-selected="true" data-ai-change-tab="0"><span>01</span>Signal</button>
          <button id="ai-change-tab-1" type="button" role="tab" aria-controls="ai-change-panel" aria-selected="false" data-ai-change-tab="1"><span>02</span>Context</button>
    ...
    <section id="contact" class="main-section contact readiness-section" data-section="contact" aria-labelledby="contact-title">
      <div class="shell readiness-console reveal" data-readiness-console>
        ...
        <div class="readiness-grid">
          <div class="readiness-step"><span>STEP 01</span><h3 data-en="What do you need to address first?">What do you need to address first?</h3><div class="choice-grid" role="group" aria-label="Integration need type" data-label-en="Integration need type"><button type="button" data-readiness-type="infrastructure" aria-pressed="false" data-en="Infrastructure">Infrastructure</button><button type="button" data-readiness-type="cloud" aria-pressed="false" data-en="Cloud and identities">Cloud and identities</button><button type="button" data-readiness-type="security" aria-pressed="false" data-en="Security and monitoring">Security and monitoring</button><button type="button" data-readiness-type="automation" aria-pressed="false" data-en="Operations automation">Operations automation</button><button type="button" data-readiness-type="ai" aria-pressed="false" data-en="AI operations">AI operations</button></div></div>
          <div class="readiness-step"><span>STEP 02</span><h3 data-en="What is the main difficulty?">What is the main difficulty?</h3><div class="choice-grid readiness-difficulties" role="group" aria-label="Primary difficulty" data-label-en="Primary difficulty" data-readiness-difficulties><p data-en="Select a priority in step one.">Select a priority in step one.</p></div></div>
